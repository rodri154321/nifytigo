    ...
    <div className={style.content}>
      ...
      <div className={style.boxNames}>
        <div className={style.gridContainer}>
          <div className={style.column}>
            ...
            <NavLink to='/programmers' className={style.navlink} onClick={goToTopPage}>Contact us</NavLink>
          ...
          <div className={style.column}>
            ...
            <NavLink to='/programmers' className={style.navlink} onClick={goToTopPage}>Terms of use</NavLink>
            <NavLink to='/programmers' className={style.navlink} onClick={goToTopPage}>Privacy Policy</NavLink>
          </div>
          <div className={style.column}>
            <h3 className={style.conocenos}>About us</h3>
            <NavLink to='/programmers' className={style.navlink} onClick={goToTopPage}>Developers</NavLink>
            <NavLink to='/programmers' className={style.navlink} onClick={goToTopPage}>FAQ</NavLink>
          </div>
        </div>
      </div>
      <div className={style.contenedorRedes}>
        ...
        <a href="https://www.instagram.com" className={style.socialLink1} target="_blank" rel="noopener noreferrer">
          ...
          <a href="https://twitter.com" className={style.socialLink2} target="_blank" rel="noopener noreferrer">
            <svg
              viewBox="0 0 16 16"
          ...
          <a href="https://discord.com" className={style.socialLink3} target="_blank" rel="noopener noreferrer">
            <svg
              viewBox="0 0 16 16"
